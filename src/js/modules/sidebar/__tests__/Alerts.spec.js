...
test("should render all the alert sub categories", () => {
  const fakeAlert = {
    ...
    count: 0,
    sub_categories: [
      { name: "Fake Alert Sub Category 1", count: 572 },
      { name: "Fake Alert Sub Category 2", count: 573 },
      { name: "Fake Alert Sub Category 3", count: 574 },
      { name: "Fake Alert Sub Category 4", count: 575 },
      { name: "Fake Alert Sub Category 5", count: 576 },
      { name: "Fake Alert Sub Category 6", count: 577 },
      { name: "Fake Alert Sub Category 7", count: 578 }
    ]
  };
...
test("should render the name of the  sub category", () => {
  const fakeAlert = {
    name: "Fake Alert",
    count: 576,
    sub_categories: [{ name: "Fake Alert Sub Category 1", count: 572 }]
  };
  const { getByText } = render(<Alerts item={fakeAlert} />);
