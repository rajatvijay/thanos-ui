export default {
  en: {
    ...
    fields: {
      ...
      alertEntityId: "Notifications Entity ID",
      alertEntitySysId: "Notifications Entity System ID",
      alias: "Alias ",
  ...
  es: {
    ...
    fields: {
      ...
      alertEntityId: "ID de entidad de notificaciones",
      alertEntitySysId: "ID del sistema de entidad de notificaciones",
      alias: "Alias",
  ...
  "fr-ca": {
    ...
    fields: {
      ...
      alertEntityId: "ID d'entité de notifications",
      alertEntitySysId: "ID du système d'entités de notifications",
      alias: "Alias",
